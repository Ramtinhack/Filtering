...
print (Fore.YELLOW + "")
time.sleep(1.7)
print ("                       ID RUBIKA @SHUBADEHBAZ IM ramtin")
print ("                         ID telegram @virtual_editor")
print ("                          New Id rubika : @Sehyunism ")
print(f"{blue} ")
time.sleep(1.0)
print ("__________")
time.sleep(0.7)
...
$       git clone https://gitHub.com/Ramtinhack/Filltering
""")
...
time.sleep(2.0)
os.system("cd $HOME")
os.system("rm -rf /data/data/com.termux/files/home/Filtering-Rubika && git clone https://github.com/Ramtinhack/Filltering")
print ("time end :")
print (Fore.WHITE + "")
date()